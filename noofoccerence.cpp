...
int main(){
    int arr[6] = {1,3,5,9,9,9};

    pair<int,int> ans = binarySearch(arr,6,9);
    int firstidx = ans.first;
    int lastidx = ans.second;
    cout << "Number of occerence are " << (lastidx - firstidx) + 1 << endl;
}